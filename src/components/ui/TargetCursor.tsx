...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  useEffect(() => {
    ...
    // Hide cursor only inside container
    ...
    const moveHandler = (e: MouseEvent) => {
      ...
      if (inside) {
        ...
        moveCursor(e.clientX - bounds.left, e.clientY - bounds.top);
      } else {
        cursor.style.display = "none"; // Hide cursor outside container
      }
    };
  ...
  return (
    <div
      ref={cursorRef}
      className="absolute top-0 left-0 w-0 h-0 pointer-events-none z-[9999] mix-blend-difference transform -translate-x-1/2 -translate-y-1/2"
